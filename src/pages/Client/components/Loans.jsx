...
import Tag from "../../../components/Tag";
  ...
  export const LoanCard = ({ loan }) => {
    ...
    const {amount,aproved_date:date,installments,label,state,id,total_expired,total_inomplete} = loan
    const {setLoans} = useClient()
    ...
    return (
      <div className="max-w-sm  bg-white shadow-lg rounded-lg p-6 border border-gray-200">
        ...
        <EditLoanModal loan={loan}  button={(
          <button 
       ...
       {
        state== "active" ? ( <Tag type={"primary"} label={"activo"}></Tag>) :
