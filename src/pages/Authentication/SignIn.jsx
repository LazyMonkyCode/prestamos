import React,{useActionState,useState,useReducer} from 'react';
...
const SignIn= () => {
  ...
  const {validate,fields,setField,errors} = useValidate({
    username:{
      value:"",
      isValid:true,
      error:""
  ...
  const submit = async(e,formData)=>{
    ...
    /*   console.log(fields.password)
       ...
       */
      const compare = await window.api.compare(fields.password.value,user[0].password)
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={submit} >
               ...
               />
                  ...
                  >
                    <path
                      d="M12 12c2.485 0 4.5-2.015 4.5-4.5S14.485 3 12 3 7.5 5.015 7.5 7.5 9.515 12 12 12zm0 1.5c-3.037 0-9 1.518-9 4.5v1.5h18v-1.5c0-2.982-5.963-4.5-9-4.5z"
                      fill="currentColor"
                    />
                  </svg>
