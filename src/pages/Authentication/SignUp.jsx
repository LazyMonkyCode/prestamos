...
const SignUp = () => {
  ...
  const {validate,fields,setField} = useValidate({
    username:{
      value:"",
      isValid:true,
      error:""
  ...
  const submit = async(e)=>{
    ...
    if(errors){
      ...
      const hash =await window.api.hash(fields.password.value)
      const user= await window.sqlite.query("INSERT INTO users (username,email,password) VALUES (?,?,?)",
        fields.username.value,
        fields.email.value,
        hash)


       const token =await window.api.generateToken({
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form onSubmit={submit}>
                ...
                <div className="mb-4">
                  ...
                  {
                    fields.email.error.length==0 ? (<></>) : (<div className='text-center text-red '>{fields.email.error}</div> )
                  }
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full rounded-lg border border-stroke bg-transparent py-4 pl-6 pr-10 text-black outline-none focus:border-primary focus-visible:shadow-none dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"
                      onChange={(e)=>setField({type:"set",field:"rpassword",value:e.target.value})}
                  ...
                  {
                    fields.rpassword.error.length==0 ? (<></>) : (<div className='text-center text-red '>{fields.rpassword.error}</div> )
                  }
                </div>
