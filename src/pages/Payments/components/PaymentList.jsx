...
const PaymentList = () => {
  ...
  const { page, limit, totalPages, setPage, search, setSearch, setPayments ,payments} = useTodayPayments()
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center text-gray-500 w-1/4">
        ...
        <Link to={"/loans/"+payment.loan_id}> <span className="text-sm font-semibold  font-medium">{payment.label}</span></Link> 
      </div>
      {/* Monto y estado */}
      <div className="flex items-center space-x-4 w-1/4">
        ...
        <div className="flex flex-end w-1/4">
          ...
          <span
            className={`px-3 py-1 rounded-full text-sm font-semibold ${payment.state === "pending"
  ...
  <div className="max-w-4xl mx-auto mt-8 space-y-4">
    {payments.map((payment) => (
      ...
      >
        ...
        <div className="flex items-center w-full md:w-1/4 mt-3 md:mt-0">
          <span
            className={`px-3 py-1 rounded-full text-sm font-semibold ${payment.status === "Pendiente"
