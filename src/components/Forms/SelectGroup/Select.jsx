    ...
    <div  className={"mb-4.5 "+className}>
      ...
      <div className="relative  bg-transparent dark:bg-form-input">
        <select
          ...
          className={`relative  w-full appearance-none rounded border border-stroke bg-transparent py-3 
            px-5 outline-none transition focus:border-primary active:border-primary
